            ...
            <div class="row">
                ...
                if (isset($_GET['inserted'])) {
                    echo '<div class="alert alert-success" >
                                               ...
                                               <strong>DONE!! </strong><p> Vehicle Feature has been successfully inserted.</p>
                                               </div>';
                } elseif (isset($_GET["deleted"])) {
                    echo
                        '<div class="alert alert-warning" >
                                              <a href="#" class="close" data-dismiss="alert" aria-label="close"></a>
                                             <strong>DELETED!! </strong><p> Vehicle Feature has been successfully deleted.</p>
                                        </div>';
                }
                ?>
                <div class="col-sm-12">
                    <div class="white-box">
                        <a href="features_insert.php" class="btn btn-info waves-effect waves-light pull-right">Insert Feature</a>
                        <h3 class="box-title m-b-0">Vehicle Special Features</h3>
                        ...
                        <div class="table-responsive">
                            <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                ...
                                if (mysqli_num_rows($query) == 0) {
                                    echo "<i style='color:brown;'>No Vehicle special features Yet </i> ";
                                } else {
                                        ...
                                        <div id="responsive-modal' . $row["id"] . '" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="functions/features.php" method="post">
