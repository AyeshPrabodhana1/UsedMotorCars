    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0">Insert New Vehicle Brand</h3>
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <form action="functions/vehicle-brand.php" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputpwd1">Image</label>
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="ti-lock"></i></div>
